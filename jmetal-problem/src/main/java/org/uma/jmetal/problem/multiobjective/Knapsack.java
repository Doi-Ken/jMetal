...
public Knapsack() throws JMetalException {
    this(500, 2, 0);
 }

public Knapsack(Integer numberOfBits, Integer numberOfObjectives) throws JMetalException{
	this(numberOfBits, numberOfObjectives, 0);
}

public Knapsack(Integer numberOfBits,
	...
	weight_limit = new double [getNumberOfObjectives()];

	weight = new double [numberOfBits][getNumberOfObjectives()];
	original_weight = new double [numberOfBits][getNumberOfObjectives()];

	profit = new double [numberOfBits][getNumberOfObjectives()];
	original_profit = new double [numberOfBits][getNumberOfObjectives()];

	profit_per_weight = new double[numberOfBits][getNumberOfObjectives()];
	original_profit_per_weight = new double[numberOfBits][getNumberOfObjectives()];
