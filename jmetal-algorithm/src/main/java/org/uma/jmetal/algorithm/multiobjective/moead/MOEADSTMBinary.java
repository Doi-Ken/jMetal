...
public class MOEADSTMBinary extends AbstractMOEAD<BinarySolution> {

	protected BinarySolution[] savedValues;
	protected double[] utility;
	protected int[] frequency;

	JMetalRandom randomGenerator;

	public MOEADSTMBinary(Problem<BinarySolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
									MutationOperator<BinarySolution> mutation, CrossoverOperator<BinarySolution> crossover,
		...
		savedValues = new BinarySolution[populationSize];
	...
	protected void initializePopulation() {
		...
		for (int i = 0; i < populationSize; i++) {
			...
			savedValues[i] = (BinarySolution) newSolution.copy();
		}
	}
	...
	public void utilityFunction() throws JMetalException {
		...
		for (int n = 0; n < populationSize; n++) {
			...
			savedValues[n] = (BinarySolution) population.get(n).copy();
		}
	}
	 ...
	 * @return
	 */
	public double calculateDistance(BinarySolution individual, double[] lambda) {
		double scale;
		double distance;
	 ...
	 * @return
	 */
	public double calculateDistance2(BinarySolution individual, double[] lambda) {
