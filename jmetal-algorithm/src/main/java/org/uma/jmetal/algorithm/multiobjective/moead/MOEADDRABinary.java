...
public class MOEADDRABinary extends AbstractMOEAD<BinarySolution> {
  ...
  public MOEADDRABinary(Problem<BinarySolution> problem, int populationSize, int resultPopulationSize, int maxEvaluations,
      MutationOperator<BinarySolution> mutation, CrossoverOperator<BinarySolution> crossover, FunctionType functionType,
