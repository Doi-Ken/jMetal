 ...
 * @version 1.0
 */
public class MOEADSBXBuilder implements AlgorithmBuilder<AbstractMOEAD<DoubleSolution>> {
  ...
  /** Constructor */
  public MOEADSBXBuilder(Problem<DoubleSolution> problem, Variant variant) {
  ...
  public MOEADSBXBuilder setPopulationSize(int populationSize) {
    this.populationSize = populationSize;

    return this;
  }

  public MOEADSBXBuilder setResultPopulationSize(int resultPopulationSize) {
    this.resultPopulationSize = resultPopulationSize;

    return this;
  }

  public MOEADSBXBuilder setMaxEvaluations(int maxEvaluations) {
    this.maxEvaluations = maxEvaluations;

    return this;
  }

  public MOEADSBXBuilder setNeighborSize(int neighborSize) {
    this.neighborSize = neighborSize ;

    return this ;
  }

  public MOEADSBXBuilder setNeighborhoodSelectionProbability(double neighborhoodSelectionProbability) {
    this.neighborhoodSelectionProbability = neighborhoodSelectionProbability ;

    return this ;
  }

  public MOEADSBXBuilder setFunctionType(MOEAD.FunctionType functionType) {
    this.functionType = functionType ;

    return this ;
  }

  public MOEADSBXBuilder setMaximumNumberOfReplacedSolutions(int maximumNumberOfReplacedSolutions) {
    this.maximumNumberOfReplacedSolutions = maximumNumberOfReplacedSolutions ;

    return this ;
  }

  public MOEADSBXBuilder setCrossover(CrossoverOperator<DoubleSolution> crossover) {
    this.crossover = crossover ;

    return this ;
  }

  public MOEADSBXBuilder setMutation(MutationOperator<DoubleSolution> mutation) {
    this.mutation = mutation ;

    return this ;
  }

  public MOEADSBXBuilder setDataDirectory(String dataDirectory) {
    this.dataDirectory = dataDirectory ;

    return this ;
  }

  public MOEADSBXBuilder setNumberOfThreads(int numberOfThreads) {
  ...
  public AbstractMOEAD<DoubleSolution> build() {
    ...
    if (moeadVariant.equals(Variant.MOEAD)) {
      ...
      algorithm = new MOEADSBX(problem, populationSize, resultPopulationSize, maxEvaluations, mutation,
  ...
  public MOEADSBXBuilder setH1(int H1_){
  	this.H1_ = H1_;

  	return this;
  }

  public MOEADSBXBuilder setH2(int H2_){
	  	this.H2_ = H2_;
