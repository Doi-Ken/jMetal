 ...
 */
public class UniformedCrossover implements CrossoverOperator<BinarySolution> {
  private double crossoverProbability ;
  private JMetalRandom randomGenerator ;

  /** Constructor */
  public UniformedCrossover(double crossoverProbability) {
  ...
  public List<BinarySolution> doCrossover(double probability, BinarySolution parent1, BinarySolution parent2)  {
    ...
    if (randomGenerator.nextDouble() < probability) {
      ...
      int[] crossoverMask = new int[totalNumberOfBits];
      ...
      for (int i = 0; i < offspring1.getBinarySetLength(); i++) {
